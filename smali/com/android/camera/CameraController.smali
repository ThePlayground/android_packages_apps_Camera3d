...
.method public getSettingsInfo(Ljava/lang/String;)Lcom/android/camera/CameraController$SettingInfo;
    ...
    const-string v2, "exposure-compensation: set value failed !!"
    ...
    :goto_1
    invoke-virtual {v1, v7}, Lcom/android/camera/CameraController$SettingInfo;->setStep(F)V
    ...
    invoke-virtual {v1, v6}, Lcom/android/camera/CameraController$SettingInfo;->setCurrent(I)V

    const-string v2, "CameraController"

    const-string v2, "saturation: set current value failed !!"
    ...
    invoke-virtual {v1, v5}, Lcom/android/camera/CameraController$SettingInfo;->setMin(I)V

    invoke-virtual {v1, v8}, Lcom/android/camera/CameraController$SettingInfo;->setMax(I)V

    const-string v2, "CameraController"

    const-string v2, "saturation: set min, max value failed !!"
    ...
    invoke-virtual {v1, v6}, Lcom/android/camera/CameraController$SettingInfo;->setDefault(I)V

    const-string v2, "CameraController"

    const-string v2, "saturation: set default value failed !!"
    ...
    const-string v2, "contrast: set current value failed !!"
    ...
    const-string v2, "contrast: set min, max value failed !!"
    ...
    const-string v2, "contrast: set default value failed !!"
    ...
    const-string v2, "sharpness: set current value failed !!"
    ...
    const-string v2, "sharpness: set min, max value failed !!"
    ...
    const-string v2, "sharpness: set default value failed !!"
...
.method public setFlashModeIgor(Ljava/lang/String;)V
    .locals 3
...
.method public setGEParam(Ljava/lang/String;IIIIZ)Z
    ...
    :cond_0
    const-string v0, "GE-param0"

    if-eq p1, v2, :cond_1

    const-string v0, "GE-param1"
    ...
    iput v5, p0, Lcom/android/camera/CameraController;->mInjectParam0:I
    ...
    const-string v1, "GE-param3"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    iget v3, p0, Lcom/android/camera/CameraController;->mInjectParam0:I
    ...
    iget v3, p0, Lcom/android/camera/CameraController;->mInjectParam1:I
    ...
    invoke-virtual {v0, p1, v1}, Landroid/hardware/Camera$Parameters;->set(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput v5, p0, Lcom/android/camera/CameraController;->mInjectParam1:I
...
.method public setLocation(Landroid/location/Location;)V
    ...
    const-string v11, "CameraController"
    ...
    const-string v7, "add gps location on photo"

    invoke-static {v11, v7}, Lcom/android/camera/LOG;->V(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v7, "not add gps location on photo - hasLatLon = false"
    ...
    const-string v7, "not add gps location on photo - loc = null"
...
.method public setSupportedList()V
    ...
    const-string v0, "setSupportedList() - mCameraParameters = null"
    ...
    const-string v0, "SupportedList.FlashMode == null"
    ...
    const-string v0, "SupportedList.FocusModes == null"
    ...
    const-string v0, "SupportedList.WhiteBalance == null"
    ...
    const-string v0, "SupportedList.Effects == null"
    ...
    const-string v0, "SupportedList.Antibanding == null"
    ...
    const-string v0, "SupportedList.SceneMode == null"
